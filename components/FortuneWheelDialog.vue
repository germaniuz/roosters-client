        ...
        <div class="fortune-wheel-dialog">
            ...
            <div class="fortune-wheel-dialog__footer">
                <p>
                    ...
                    доставка любимых пицц прямо к вам домой! Независимо от дня и времени, вы всегда можете насладиться
                    ароматной, горячей пиццей. Наши операторы свяжутся с вами для подтверждения заказа и сообщат время
                    доставки, которое может немного превышать 60 минут, чтобы вы точно знали, когда ждать свой вкусный
                    заказ.
                </p>
            </div>
        </div>
