...
<template>
    ...
    <div class="container">
        <BaseNotice
            v-if="isActiveShopWorking === false && activeShop && activeDeliveryType.key === DELIVERY_TYPE.PICKUP"
        ...
        <BaseNotice
            v-if="isActiveShopWorking === false && activeShop && activeDeliveryType.key === DELIVERY_TYPE.DELIVERY"
        >
        </BaseNotice>
    </div>
    <ClientOnly>
